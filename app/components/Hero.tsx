    ...
    <div className="pt-4 lg:pt-10">
      ...
      <div className="relative flex justify-center h-full w-full">
        ...
        <div className="absolute bottom-5 flex w-full flex-col items-center">
          ...
          <div className="flex flex-col items-center w-full lg:flex-row lg:justify-center lg:gap-12">
            <p className="text-[#fff] text-center mt-3 lg:text-[18px]">
              Trusted by these companies
            </p>

            <div className="pt-2">
              <div className="grid grid-cols-2 items-center justify-center justify-items-center px-[5px] align-middle lg:inline-flex lg:gap-4">
                <Image src={Google} alt="Google" />
                <Image src={Slack} alt="Slack" />
              </div>
              <div className="grid grid-cols-3 items-center justify-center justify-items-center px-[20px] align-middle lg:inline-flex lg:gap-4 ">
